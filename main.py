...
def setup_drivers(frame):
    ...
    #     frame,
    #     text="Sort By CID",
    #     command=lambda: sort_by_cid(display_frame),
    # ).grid(row=3, column=4, pady=10)

    # ttk.Button(
    #     frame,
    #     text="Sort By Name",
    #     command=lambda: sort_by_name(display_frame),
    # ).grid(row=3, column=5, pady=10)

    # ttk.Button(
    #     frame,
    #     text="Sort By Manager",
    #     command=lambda: sort_by_manager(display_frame),
    ...
    # cid_entry_goto.grid(row=4, column=1, padx=10, pady=5)
    ...
    #     row=4, column=3, columnspan=4, pady=10
    # )
...
def go_to_company(cid):
    ...
    if not cid:
        ...
        notebook.add(vehicles_drivers_frame, text="Vehicles & Drivers Relation")

        setup_vehicles(vehicles_frame)
        setup_drivers(drivers_frame)
        # setup_vehicles_drivers(vehicles_drivers_frame)
...
def show_login_screen():
    ...
    ttk.Button(root, text="Exit", command=exit).grid(row=3, column=0, columnspan=2)
